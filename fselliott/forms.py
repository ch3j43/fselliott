...
class VendorForm(forms.Form):
    ...
    zip = CustomCharField(label=_("Zip/Postal Code"), required=False, widget=forms.TextInput(attrs={'class':'span6'}))
...
class ContactForm(forms.Form):
    name = CustomCharField(label=_("Name"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    position = CustomCharField(label=_("Position"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    email = CustomCharField(label=_("Email"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    mobile = CustomCharField(label=_("Mobile"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    departments = Department.objects.all().values_list('id','name')
    department = forms.ChoiceField(label=_("Department"), choices=departments, widget=forms.Select(attrs={'class':'span6'}))
    telephone = CustomCharField(label=_("Telephone"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    fax = CustomCharField(label=_("Fax"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    
class CustomerForm(forms.Form):
    company_name = CustomCharField(label=_("Company Name"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    telephone = CustomCharField(label=_("Telephone"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
    fax = CustomCharField(label=_("Fax"), required=True, widget=forms.TextInput(attrs={'class':'span6'}))
